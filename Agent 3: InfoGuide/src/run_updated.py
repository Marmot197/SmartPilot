...
if user_input:
    ...
    # 🟣 Production forecasting
        ...
        if process_response is None:
            ...
            try:
                response = llm.respond_to_prompt_json()
            except Exception as e:
            ...
            try:
                topic = json.loads(response)['Response']['topic']
                # dict = {'Question': user_input, 'Topic': topic,'Reason': json.loads(response)['Response']['reason']}
            except:
                topic = json.loads(response)['topic']
            dict = {'Question': user_input, 'Topic': 'undefined','Reason':response}
                # print(response)
            with open('topic.jsonl', 'a') as f:
